...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "نمایش page _PAGE_ of _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "نمایش _START_ to _END_ of _TOTAL_ entries",
			 ...
			 *  @type string
			 *  @default نمایش 0 to 0 of 0 entries
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sLengthMenu": "تعداد نمایش : _MENU_",
